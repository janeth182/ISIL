...
using ValidationHOL.CustomValidators.Configuration;
...
namespace ValidationHOL.CustomValidators
{
    ...
    public class SSNValidator : Validator<string>
    {
        ...
        {
            string ignoreHyphensValue = attributes.Get("ignoreHyphens");

            if (ignoreHyphensValue != null)
            {
                this.ignoreHypens = ignoreHyphensValue == "true";
            }
        }
