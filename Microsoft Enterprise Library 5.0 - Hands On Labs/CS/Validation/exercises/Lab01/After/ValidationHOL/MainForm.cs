    ...
    public partial class MainForm : Form
    {
        ...
        private void acceptButton_Click(object sender, EventArgs e)
        {
            ...
            if (!results.IsValid)
            {
                ...
                MessageBox.Show(this, builder.ToString(), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error); return;
            }

            MessageBox.Show(this, "Processing customer '" + customer.FirstName + "'", "Working", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
